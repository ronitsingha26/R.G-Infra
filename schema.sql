...
CREATE TABLE IF NOT EXISTS communication_history (
  ...
  client_id        INT NOT NULL,
  flat_id          INT,
  type             ENUM('demand_letter','email','whatsapp','payment_receipt') NOT NULL,
...
CREATE TABLE IF NOT EXISTS communication_logs (
  ...
  message_type          ENUM('demand_letter','payment_due','payment_receipt','reminder','general') NOT NULL,
  subject               VARCHAR(500),
  message               TEXT,
...
-- 15. CLIENT PAYMENTS (Actual payment records)
